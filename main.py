...
try:
    ...
    while True:
        ...
        logging.log(24, 'Need help? See here: https://art-from-the-machine.github.io/Mantella/pages/issues_qna')
        logging.log(24, 'Waiting for player to select an NPC for Communication...')
